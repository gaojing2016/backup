...
void cloudc_rpc_method_handle(struct http_value recv_data)
{
    ...
    switch(recv_data.rpc_flag)
    {
        ...
        case eIpkOperation:
            cloudc_manage_ipk(recv_data.rpc_cmd, recv_data.serial_num, recv_data.ipk_name_head, recv_data.real_ipk_num);
            break;
        ...
        case eServiceOperation:
            cloudc_manage_service(recv_data.rpc_cmd, recv_data.serial_num, recv_data.ipk_name_head, recv_data.real_ipk_num);
            break;
