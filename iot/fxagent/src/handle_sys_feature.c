...
int cloudc_manage_alljoyn_update_devid(char *op_type, int serial_num, char *device_id, char *device_sn);
...
void cloudc_rpc_method_handle(struct http_value recv_data)
{
    ...
    switch(recv_data.rpc_flag)
    {
        ...
        case eAlljoynUpdateDeviceId:
            cloudc_manage_alljoyn_update_devid(recv_data.rpc_cmd, recv_data.serial_num, recv_data.device_id, recv_data.device_sn);
