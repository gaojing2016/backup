...
int protoDevOnlineBuf(char *manufacture, char * moduleNumber, char *deviceId, char *deviceType, char *specialConfig, char *jsBuf)
{
...

    {
        ...
        cJSON_AddStringToObject(json_root, "line1Display", "line1");
        cJSON_AddStringToObject(json_root, "line2Display", "line2");
        cJSON_AddStringToObject(json_root, "power", "1");
        cJSON_AddStringToObject(json_root, "name", "feixunFlight");
        cJSON_AddStringToObject(json_root, "deviceType", "led");
        cJSON_AddStringToObject(json_root, "manufacture", "feixun");
        cJSON_AddStringToObject(json_root, "manufactureDataModelId", "12");
        ...
        cJSON_AddStringToObject(json_root, "manufactureSN", deviceId);
        cJSON_AddStringToObject(json_root, "transportType", "zigbee");
